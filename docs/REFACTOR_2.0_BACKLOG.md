...
| 3 构建 | 7 | 7 | 0 | 100% | ~8d | 0 |
| 4 business | 7 | 7 | 0 | 100% | ~9d | 0 |
| 5 profile-v1 | 6 | 6 | 0 | 100% | ~4.5d | 0 |
| 6 稳定 | 5 | 5 | 0 | 100% | ~3.5d | 0 |
| **合计** | **58** | **58** | **0** | **100%** | **~59d** | **0** |

**当前版本**：`2.0.0`

### 13.1 剩余任务

无。2.0 重构 backlog **已全部完成**（2026-06-09）。
...
| 日期 | 变更 |
|------|------|
| 2026-06-09 | **发布 v2.0.0 stable**（R2-605）：huarongdao/mikuFlick 迁 profile-v1；backlog **58/58** |
| 2026-06-09 | **发布 v2.0.0-beta.0**（R2-602）：common API 冻结；tag `v2.0.0-beta.0` |
| 2026-06-09 | **R2-604**：`maintenance/1.6` 自 `v1.6.114` + `docs/MAINTENANCE_1.6.md` |
| 2026-06-09 | **发布 v2.0.0-alpha.8**（R2-407）：commit `805f172` + git tag |
