...
export default defineConfig({
  ...
  entry: {
    ...
    'showmasterpiece/index': 'src/business/showmasterpiece/ui/web/index.ts',
    'showmasterpiece/core': 'src/business/showmasterpiece/logic/index.ts',
    'showmasterpiece/web/index': 'src/business/showmasterpiece/ui/web/index.ts',
    'showmasterpiece/service/index': 'src/business/showmasterpiece/service/index.ts',
    'showmasterpiece/service/api/index': 'src/business/showmasterpiece/service/api/index.ts',
    'showmasterpiece/service/web/index': 'src/business/showmasterpiece/service/web/index.ts',
    'showmasterpiece/service/client-business/index': 'src/business/showmasterpiece/service/client-business/index.ts',
    'showmasterpiece/service/miniapp/index': 'src/business/showmasterpiece/service/miniapp/index.ts',
    'showmasterpiece/ui/web/index': 'src/business/showmasterpiece/ui/web/index.ts',
    'showmasterpiece/ui/miniapp/index': 'src/business/showmasterpiece/ui/miniapp/index.ts',
    'showmasterpiece/logic/index': 'src/business/showmasterpiece/logic/index.ts',
    'showmasterpiece/db': 'src/business/showmasterpiece/server/index.ts',
    'showmasterpiece/server/index': 'src/business/showmasterpiece/server/index.ts',
